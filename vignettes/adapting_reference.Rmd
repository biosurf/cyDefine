...
plot_adapted_omip69 <- umap_ref_omip69$data |> 
  ...
  plot_embedding(
    add_centroids = "text",
    highlight_labels = T,
    title = "Adapted reference for OMIP69",
    colors = colors,
    col = "celltype")
...
# full_plot
ggsave(full_plot_small, filename = "../figs/adapt_reference_omip23_omip69.png", units = "cm", height = 25, width = 35)
full_plot_small
```
